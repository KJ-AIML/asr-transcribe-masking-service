...
async def process_wav_file_endpoint(
    ...
    with_transcription: bool = Query(False, description="Whether to perform full transcription with all ASR models"),
    ...
    try:
        ...
        logger.info(f"Received WAV file: {file.filename}, size: {file.size}, transcription: {with_transcription}")
