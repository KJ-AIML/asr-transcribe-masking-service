...
from src.agents.schemas.types import (
    ContextExtensionArgs,
    DetectionsInRangeArgs,
    OriginalTextRangeArgs,
)
...
def get_detections_in_range(
    start_time: float, end_time: float, detections_data: List[Dict[str, Any]] = None
) -> Dict[str, Any]:
    """
...
def get_original_text_range(
    start_time: float, end_time: float, transcript_data: Dict[str, Any] = None
) -> Dict[str, Any]:
    """
